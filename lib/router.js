								...
								=	function(params,source)
									{
										...
										if(_.isUndefined(source))
											...
											.then(
												function(source)
												{
													//	console.log("hereeeeeeee",source)
													deferred
														.resolve(
															_.extend(
																{
						...
						return	function(promised_data,query)
							{
								...
								,	async_get_embeddeds
								=	function(embeddeds,links,current,remaining,source,callback)
									{
										async_resolve_link(links[current],source)
										.then(
											function(result)
											{
												embeddeds[current] = result
								...
								=	function(item)
									{
											...
											deferred
												.resolve(
													_.objMap(
														associations
													,	function(assoc){
															return assoc.get_resource_url(item)
														}
													)
												)
										...
										//resuelve solo linked												
										// async_resolve_linked(assocs[current],source)
										// .then(
										// 	function(result)
										// 	{
										// 		_.extend(
