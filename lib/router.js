						...
						return	function(promised_data,collection_query,profile,collection_url)
							{
								...
								=	function(assoc,linked_type,embedded_type,assoc_generic_link,item)
									{
										console.log("async_resolve_linked_nested")
										var	deferred
										=	Q.defer()
								...
								=	function(item)
									{
										...
										if(_.contains(visited,resource_url)) {
										
											deferred
												.resolve(
													new hal_builder({},resource_url)
												)

											console.log("Avoided CR routing: " +resource_url)
										}
										else{
											register_url(resource_url)
