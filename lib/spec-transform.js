			...
			return	function(store,spec)
				{
					...
					.each(
						...
						//console.log(transform_entry,transform_spec)
										...
										var	circular_detector
										=	[]
										,	push_spec
										=	function(spec)
											{
												circular_detector.push(spec.source.name)
											}
										,	pop_spec
										=	function()
											{
											return	circular_detector.pop()
											}
										,	is_valid
										=	function(spec)
											{
											return	!_(circular_detector).contains(spec.source.name)
											}
										,	embeded_checked
										=	function(spec,func)
											{
																		...
																		,	function()
																			...
																			(
																				...
																				.map(
																					...
																					{
																					return	spec_transformers[a_spec.target.name](source_item)
																					}
																				)
																			)
																			}
																		...
																		,	function()
																			{
																				(
																					...
																					spec_transformers[target.name](stored_item)
																				)
																			}
																		)
																	}
